...
public class MetricsRunner {
    public static void main(String[] args) {
        JavaClasses classes = new ClassFileImporter().withImportOption(ImportOption.Predefined.DO_NOT_INCLUDE_TESTS).importPackages("alexp.blog");
        Set<JavaPackage> packages = classes.getPackage("alexp.blog").getSubpackages();
